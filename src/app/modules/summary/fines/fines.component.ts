...
export class FinesComponent implements OnInit {
  ...
  expectedFinesSummary$: Observable<any>;
  expectedFinesSummaryString$: Observable<string>;

  constructor(private store: Store<ApplicationState>, private fineService: FineService) {
    ...
    this.expectedFinesSummaryString$ = this.store.pipe(select(expectedFineSelector.selectExpectedFineTypeSummaryString));
    this.expectedFinesSummary$ = this.store.pipe(select(expectedFineSelector.selectExpectedFineTypesSummary));
