  ...
  ngOnInit(): void {
    if (this.group) {
      if (this.group.member_permission) {
        ...
        this.passwordReset = this.group.member_permission?.passwordReset;
      } else {
        if (this.group.chairperson) {
          ...
          this.passwordReset.push(this.group.chairperson);
        }
        if (this.group.secretary) {
          ...
          this.passwordReset.push(this.group.secretary);
        }
        if (this.group.treasure) {
          ...
          this.passwordReset.push(this.group.treasure);
        }
      }
    }
  }
