...
import * as fromReducer from './cash-transfer.reducer';
import {selectGroupId} from '../user/user.selectors';

export const selectCurrentState = createFeatureSelector<fromReducer.State>(fromReducer.cashTransfersFeatureKey);
