...
import * as fromReducer from './announcement.reducer';

export const selectCurrentState = createFeatureSelector<fromReducer.State>(fromReducer.announcementsFeatureKey);
