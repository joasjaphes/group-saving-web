...
import * as fromReducer from './long-term-investment-type.reducer';

export const selectCurrentState = createFeatureSelector<fromReducer.State>(fromReducer.longTermInvestmentTypesFeatureKey);
