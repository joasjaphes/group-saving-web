...
import * as fromReducer from './long-term-investment-item.reducer';

export const selectCurrentState = createFeatureSelector<fromReducer.State>(fromReducer.longTermInvestmentItemsFeatureKey);
