...
export const selectedWithLoan = createSelector(selectByCurrentGroup, (allItems) => allItems.filter((i) => i.allow_loan));

export const selectRepeating = createSelector(selectByCurrentGroup, (allItems) => allItems.filter((i) => !i.is_one_time_contribution));

export const selectOneTime = createSelector(selectByCurrentGroup, (allItems) => allItems.filter((i) => i.is_one_time_contribution));
