...
import * as fromReducer from './loan-request.reducer';
import {selectGroupId} from '../user/user.selectors';

export const selectCurrentState = createFeatureSelector<fromReducer.State>(fromReducer.loanRequestsFeatureKey);
