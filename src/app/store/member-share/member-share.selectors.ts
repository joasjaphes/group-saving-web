...
import * as fromReducer from './member-share.reducer';

export const selectCurrentState = createFeatureSelector<fromReducer.State>(fromReducer.memberSharesFeatureKey);
