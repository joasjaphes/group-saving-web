...
import * as fromReducer from './contribution-type-balance.reducer';

export const selectCurrentState = createFeatureSelector<fromReducer.State>(fromReducer.contributionTypeBalancesFeatureKey);
