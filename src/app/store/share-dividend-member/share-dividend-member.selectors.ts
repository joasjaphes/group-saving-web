...
import * as fromReducer from './share-dividend-member.reducer';

export const selectCurrentState = createFeatureSelector<fromReducer.State>(fromReducer.shareDividendMembersFeatureKey);
