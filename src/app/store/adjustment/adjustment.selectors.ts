...
import * as fromReducer from './adjustment.reducer';
import {selectGroupId} from '../user/user.selectors';

export const selectCurrentState = createFeatureSelector<fromReducer.State>(fromReducer.adjustmentsFeatureKey);
