...
function prepareContributionData(data: any, contributionTypeId: string, last_update: any) {
    return {
        ...
        is_hisa: data.contibutionKey === 'Share',
        hisa_value: data.contibutionKey === 'Share' ? data.valuePerShare : 0,
        new_hisa_value: data.contibutionKey === 'Share' ? data.valuePerShare : 0,
